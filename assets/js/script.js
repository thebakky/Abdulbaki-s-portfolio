...
const projects = [
    {
        ...
        image: 'assets/images/e-commerce.jpg', // ← replace .svg with your real image
    ...
    },
    {
        ...
        image: 'assets/images/portfolio.jpg', // ← replace with your image
        tags: ['HTML', 'CSS', 'JavaScript'],
        link: '#'
    },
    {
        ...
        image: 'assets/images/mobile interface.jpg',    // ← replace with your image
        tags: ['HTML', 'CSS', 'JavaScript'],
        link: '#'
    }
];
...
footerCopy.textContent = '© ' + new Date().getFullYear() + ' Abdulbaki. All rights reserved.';
